...
- [Introduction](#introduction)
    - [What you need for Alexa Account Linking](#what-you-need-for-alexa-account-linking)
- [How OAuth2 Works](#how-oauth2-works)
- [What is Auth0?](#what-is-auth0)
- [Alexa Account Linking: Connecting your Skill with Auth0](#alexa-account-linking-connecting-your-skill-with-auth0)
    - [1. Auth0 Setup](#1-auth0-setup)
        - [Create an Application](#create-an-application)
        - [Social Logins](#social-logins)
    - [2. Alexa Skill Setup](#2-alexa-skill-setup)
    - [3. Add Account Linking to Your Code](#3-add-account-linking-to-your-code)


👉 Just interested in a user's email address? Take a look at [Login with Amazon](https://www.jovo.tech/tutorials/alexa-login-with-amazon-email/). 

👉 Interested in Google Assistant Account Linking? [How to set up Account Linking for Google Actions with Auth0 and Jovo](https://www.jovo.tech/tutorials/google-action-account-linking-auth0/).   
...
[OAuth 2.0](https://oauth.net/2/) is an authorization protocol which allows third-party applications to gain limited access to an HTTP service. It enables the user to provide access to restricted resources, without giving away their credentials (username and password).
...
In the following steps, we are going to use both _username + password_ and _social login_ features by Auth0 to create an Account Linking process for our Alexa Skill.
...
1. Set up an Auth0 application and the providers we want to use for _social login_
2. Fill out the Account Linking form on the Amazon Alexa Developer platform 3. Add the code, so we can prompt our users to link their account with our Skill.
...
If you don't already have on, go to the [Amazon Developer Platform](https://developer.amazon.com/), create an Alexa Skill and open the **Account Linking** tab:
...
👉 Just getting started with Alexa Skill development? Take a look here: [Build an Alexa Skill in Node.js with Jovo](https://www.jovo.tech/tutorials/alexa-skill-tutorial-nodejs/).
